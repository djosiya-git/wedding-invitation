...
<main class="app">
  <header>
    ...
    <a class="btn primary" href="customer_login.php" target="_blank">Buka Login Pelanggan</a>
  </header>
  ...
  <section class="panel">
    ...
    <?php else:?>
      <div class="table-wrap">
        <table>
          <thead>
            <tr><th>Undangan</th><th>Slug</th><th>Username</th><th>Password Baru</th><th>Status Akun</th><th></th></tr>
          </thead>
          <tbody>
