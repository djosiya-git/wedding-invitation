...
<main class="app narrow">
  ...
  <form class="panel form" method="post">
    ...
    <label>Pilih template<select name="template"><?php foreach($groups as $group): if(!$group['templates']) continue; ?><optgroup label="<?=e($group['label'])?>"><?php foreach($group['templates'] as $k=>$t):?><option value="<?=e($k)?>" <?=$selected===$k?'selected':''?>><?=e($t['name'])?></option><?php endforeach?></optgroup><?php endforeach?></select></label>
